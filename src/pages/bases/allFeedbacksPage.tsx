                        ...
                        >
                            ...
                            >
                                <FlagButton
                                    ...
                                    text="По новизне"
                                    initialState={isNewly}
                                    onChangeActive={handleSetIsNEwly}
                                    onChangeDirectionSorting={(value) => {
                                        setIsDirectionIsNewLy(value);
                                    }}
                                />
                                <FlagButton
                                    className={styles.flag_button}
                                    text="По рейтингу"
                                    initialState={isRatingly}
                                    onChangeActive={handleSetISRatingly}
                                    onChangeDirectionSorting={
                                        setIsDirectionIsRatingly
                                    }
                                />
                            </div>

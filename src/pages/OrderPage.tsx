...
const PriceDisplay: React.FC<{
    ...
    infoAboutOrder: infoAboutOrderInterface | null;
}> = ({ PromoCode, infoAboutOrder }) => {
...
const OrderPage: FunctionComponent = () => {
    ...
    const [infoAboutOrder, SetInfoAboutOrder] =
        useState<infoAboutOrderInterface | null>(null);
    ...
    useEffect(() => {
        ...
        axios
            .get("/api/v1/get_info_for_order/", config)
            .then((response) => {
                if (
                    type == "PRODUCT" ||
                    type == "SUBSCRIPTION" ||
    ...
    const handleCreateOrder = () => {
        ...
        if (user == null) {
            axios
                .post(
                    "/api/v1/auth/registration/fast_register/",
                    {
                        username: Username,
                        phone_number: "+" + Phone,
                        email: Email,
    ...
    useEffect(() => {
        ...
        if (order_id) {
            ...
            axios
                .get("/api/v1/payment/check/" + order_id + "/", {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
                })
        ...
        const GetCost = async () => {
            if (type === "WALLET") {
                ...
                if (searchParams.get("is_deluxe") === "true") {
                    var cost =
                        infoAboutOrder?.product?.deluxe_or_premium_cost || 0; // значение по умолчанию 0, если cost  undefined
                } else {
                    var cost = infoAboutOrder?.product?.cost || 0; // значение по умолчанию 0, если cost  undefined
                }
                setPromoPrice(
                    PriceDisplay({ PromoCode, infoAboutOrder }) as number
                );
    ...
    if (width >= maxWidth) {
                ...
                <BaseCenterContainer style={{ zoom: 0.9 }}>
                        ...
                        <div className={styles.container}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {infoAboutOrder?.product?.title ||
                                            infoAboutOrder?.wallet?.title}{" "}
                                        <span
                                            style={{
                                                color: "var(--color-silver-100)",
                                            }}
                                        >
                                            {infoAboutOrder?.product
                                                ?.product_type ===
                                            "SUBSCRIPTION"
                                                ? `${infoAboutOrder?.product?.subscription_duration_mouth} МЕС *`
                                                : ""}
                                        </span>
                                    </span>
                                    {infoAboutOrder?.product?.product_type ? (
                                        <span
                                            style={{
                                                textAlign: "end",
                                                maxWidth: "200px",
                                        ...
                                        >
                                            ...
                                            infoAboutOrder?.product
                                                ...
                                                ? "* Срок подписки может быть меньше до 2 недель"
                                                : ""}
                                        </span>
                                    ) : null}
                                    {infoAboutOrder?.wallet ? (
                                        <span
                                            style={{
                                                fontFamily: "Unbounded_Bold",
                                                color: "var(--color-silver-100)",
                                        ...
                                        >
                                            {infoAboutOrder?.wallet?.country} на{" "}
                                            {value} {infoAboutOrder?.wallet.tag}
                                        </span>
                                    ) : null}
                                </div>
                            </div>
                            ...
                            <div style={{ display: "flex", gap: "20px" }}>
                                <div className={styles.container_order_info}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Input
                                                value={
                                                    infoAboutOrder?.product?.platforms.filter(
                                                        (item) =>
                                                            item.id ===
                                                            platform_id
                                                    )[0]?.title ??
                                                    "У данного товара отсутствуют платформы"
                                                }
                                                style={{ width: "344px" }}
                                                isDisabled
                                            />
                                    ...
                                    <textarea
                                        ...
                                        value={commentsForOrder}
                                        onChange={(e: any) => {
                                            setCommentsForOrder(e.target.value);
                                        }}
                                    />
                                ...
                                >
                                    <div
                                        className={styles.container_pay}
                                        style={{ gap: "14px" }}
                                    >
                                        <div
                                            style={{
                                        ...
                                        {PromoCode ? (
                                            ...
                                            >
                                                ...
                                                >
                                                    <img
                                                        src={
                                                            "/icons/bases/arrows/arrow_left.svg"
                                                        }
                                                        style={{
                                                            cursor: "pointer",
                                                            scale: "1.5",
                    ...
                    {isDone ? (
                        <div className={styles.complete_order}>
                            ...
                            <img
                                src="/icons/backgrounds/like.png"
                            ...
                            >
                                ...
                                >
                                    Перейдите в чат для дальнейшего оформления
                                    подписки
                                </div>
                            </div>

                            <Link
                                to={"../profile/chats/?chat=" + resultChatId}
                    ...
                    {WaitingForPayment ? (
                        <div className={styles.complete_order}>
                            ...
                            >
                                ...
                                >
                                    Дождитесь автоматического перехода на
                                    страницу оплаты или нажмите на кнопку{" "}
                                </div>
                            </div>
                    ...
                    {isErrorPayment ? (
                        <div className={styles.complete_order}>
                            ...
                            >
                                ...
                                >
                                    Произошла ошибка, при оплате попробуйте еще
                                    раз
                                </div>
                            </div>
        ...
        return (
            <div className={styles.main_container}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <span style={{ fontFamily: "Unbounded_Bold" }}>
                                    {infoAboutOrder?.product?.title}{" "}
                                    <span
                                        style={{
                                            color: "var(--color-silver-100)",
                            ...
                            {!user ? (
                                <div
                                    className={styles.container_order_info}
                                    style={{
                                        maxWidth: "320px",
                                        height: "100%",
                                        width: "auto",
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        конфиденциальности в отношении обработки
                                        персональных данных и политикой оферты
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {isDone ? (
                    <div
                        className={styles.complete_order}
                        style={{ maxWidth: "calc(320px - 50px)", left: "8%" }}
                    >
                        <Link to={"../"} style={{ alignSelf: "end" }}>
                            <img
                                src="/icons/bases/close.svg"
                ...
                {WaitingForPayment ? (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Дождитесь автоматического перехода на страницу
                                оплаты или нажмите на кнопку{" "}
                            </div>
                        </div>
                ...
                <div
                    style={{
                        marginTop: "auto",
                        filter: isDone || WaitingForPayment ? "blur(22px)" : "",
                    }}
                >
                    <Footer />
                </div>

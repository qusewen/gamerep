...
function ProductPage() {
    ...
    if (product?.images_or_videos) {
        imageUrls = [product.general_image].concat(
            product?.images_or_videos
    ...
    const DescriptionTexts = [
        ...
        <span>
            ...
            <p>
                Если у Вас <b>Ps5</b>, то Вам нужно зайти обратно на
                приобретенный аккаунт и включить функцию общего доступа, после
                этого замочек пропадет.
            </p>
            <p>
                Для этого заходите на наш аккаунт {"->"} <b>настройки</b> {"->"}{" "}
                <b>Пользователи и учетные записи</b> {"->"}{" "}
                <b>Другое (в левой колонке)</b> {"->"}{" "}
                <b>Общий доступ к консоли и автономная игра</b> {"->"}{" "}
                <b>Включить</b>. После этого замки с игр на Ваших аккаунтах
                спадут.
            </p>
            Если у Вас <b>PS4</b>, то Вам нужно зайти обратно на приобретенный
            аккаунт и включить функцию "Активировать консоль как основную",
            после этого замочек пропадет. Как это сделать:{" "}
            <b>Переходите в настройки</b> {"->"}{" "}
            <b>Управление учетной записью</b> {"->"}{" "}
            <b>Активировать консоль как основную</b> {"->"} <b>Активировать</b>.
            После этого замки с игр спадут.
        </span>,
        `Есть ли русская озвучка: ${
            product?.is_rus_voice ? "Да" : "Нет"
        } \nЕсть ли русские субтитры: ${
            product?.is_rus_subtitle ? "Да" : "Нет"
        }`,
    ];
    ...
    useEffect(() => {
        const handleScroll = () => {
            if (
                ...
                document.body.clientHeight - 297
            ) {
                setIsFixed(true);
            } else {
                setIsFixed(false);
    ...
    const handleRedirectOrder = () => {
        var ordersCreateUrl =
            `/order/create?type=${"PRODUCT"}&id=${id}&is_deluxe=${
                                                ...
                                                <img
                                                    ...
                                                    className={
                                                        ...
                                                        visibleImageIndex
                                                            ? styles.img_active
                                                            : styles.img_inactive
                                                    } // All images are active within the slider
                                                    width={"78px"}
                                                    height={"78px"}
                                                    onClick={() =>
            ...
            <div className={styles.container} style={{ paddingTop: "0" }}>
                ...
                >
                    ...
                    >
                                ...
                                {product?.platforms.map(
                                    (platform: any, index: number) => (
                                        <div
                                            ...
                                            onClick={() => {
                                                setSelectPlatform(platform.id);
                                                setSearchParams({
                                                    is_deluxe: !selectEdition
                                                        ? "false"
                                                        : "true",
                                                    platform_id: String(
                                                        platform.id
                        ...
                        <div className={styles.flexContainer}>
                            <div className={styles.publicationSelect}>
                                Издание:
                            </div>
                            <div className={styles.publications}>
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        setSearchParams({
                                            is_deluxe: "false",
                                            platform_id: String(selectPlatform),
                                        });
                                    }}
                                >
                                    Standart Edition
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    {selectEdition === 1 ? (
                                        product?.deluxe_or_premium_discount
                                            ?.discount_cost ? (
                                            <div
                                                style={{
                                                    color: "rgb(132, 130, 143)",
                                            ...
                                            >
                                                ...
                                                >
                                                    {(product?.deluxe_or_premium_cost ??
                                                        0) -
                                                        product

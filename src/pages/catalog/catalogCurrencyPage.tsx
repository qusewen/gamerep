...
import InputWithSuffix from "../../components/ui/InputWithSuffix/inputWithSuffix";
...
function catalogCurrencyPage(data: any) {
    const [searchParams, _setSearchParams] = useSearchParams();

    const [CostFilterRange, setCostFilterRange] = useState<[number, number]>([
        500, 5000,
    ]);
    const [CostFilterRangeMinMax, setCostFilterRangeMinMax] = useState<
        [number, number]
    >([0, 0]);
    ...
    const [isDirectionSortingDiscount, SetIsDirectionDiscount] =
        useState(false);
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.get(
                    "/api/v1/products/get_min_max_cost/"
                );
                setCostFilterRangeMinMax([
    ...
    const handleChangeBeginRange = (value: string) => {
        ...
        if (newValue > 0) {
            ...
            setCostFilterRange([0, CostFilterRange[1]]);
        }
    ...
    const handleChangeEndRange = (value: string) => {
        ...
        if (newValue > 0) {
            ...
            setCostFilterRange([CostFilterRange[0], 0]);
        }
    ...
    const handleClickGetProduct = async () => {
        ...
        const sortPopular = isActivePopular
            ? Number(!isDirectionSortingPopular)
            : null;
        const sortDicount = isActiveDiscount
            ? Number(!isDirectionSortingDiscount)
            : null;
        ...
        try {
            const response = await axios.get("/api/v1/products/", {
                params: {
                    ...
                    standart_or_deluxe:
                        isDeluxe && !isStandart ? isDeluxe : false,
                    is_hit: isHit,
                    is_new: isNew,
                },
            });
                    ...
                    <div className={styles.background}>
                        ...
                        <div className={styles.main_panel}>
                            <div className={styles.menu}>
                                ...
                                <Checkbox
                                    label="Новинка"
                                    onChange={handleSetIsNew}
                                    style={{ marginLeft: "12px" }}
                                />
                                <Checkbox
                                    label="Хит"
                                    onChange={handleSetIsHit}
                                    style={{ marginLeft: "12px" }}
                                />
                                ...
                                <Checkbox
                                    label="Ps5"
                                    onChange={handleSetIsPS5}
                                    style={{ marginLeft: "12px" }}
                                />
                                <Checkbox
                                    label="Ps4"
                                    onChange={handleSetIsPS4}
                                    style={{ marginLeft: "12px" }}
                                />
                                ...
                                <Checkbox
                                    label="Standart"
                                    style={{ marginLeft: "12px" }}
                                    onChange={setisStandart}
                                    checked={isStandart}
                                />
                                <Checkbox
                                    label="Deluxe/Premium"
                                    style={{ marginLeft: "12px" }}
                                    onChange={setisDeluxe}
                                    checked={isDeluxe}
                                />
                                ...
                                {CostFilterRangeMinMax[0] !== 0 &&
                                CostFilterRangeMinMax[1] !== 0 ? (
                                    <MultiRangeSlider
                                ...
                                <div
                                    ...
                                    className={styles.input_range_container}
                                >
                                    <InputWithSuffix
                                        sub_styles={{ width: "101px" }}
                                        suffix="₽"
                                        suffixProps={{ style: { top: "12px" } }}
                                        inputProps={{
                                            max: CostFilterRangeMinMax[1],
                                            min: CostFilterRangeMinMax[0],
                                        }}
                                        value={String(CostFilterRange[0])}
                                        onChange={handleChangeBeginRange}
                                    />
                                    <InputWithSuffix
                                        sub_styles={{ width: "101px" }}
                                        suffix="₽"
                                        ...
                                        value={String(CostFilterRange[1])}
                                        onChange={handleChangeEndRange}
                                    />
                                </div>
                                <div
                                    className={styles.button}
                                    onClick={handleClickGetProduct}
                                >
                                    Обновить
                                </div>
                            </div>
                            <div className={styles.general}>
                                    ...
                                    >
                                        ...
                                        >
                                            <FlagButton
                                                ...
                                                text="Цене"
                                                initialState={isActiveCost}
                                                onChangeActive={
                                                    handleIsActiveCost
                                                }
                                                onChangeDirectionSorting={
                                                    handleIsDirectionCost
                                                }
                                            />
                                            <FlagButton
                                                className={styles.flag_button}
                                                text="Популярности"
                                                initialState={isActivePopular}
                                                onChangeActive={
                                                    handleIsActivePopular
                                                }
                                                onChangeDirectionSorting={
                                                    handleIsDirectionPopular
                                                }
                                            />
                                            <FlagButton
                                                className={styles.flag_button}
                                                text="Скидке"
                                                initialState={isActiveDiscount}
                                                onChangeActive={
                                                    handleIsActiveDiscount
                                                }
                                                onChangeDirectionSorting={
                                                    handleIsDirectionDiscount
                                                }
                                            />
                                        </div>
                                        <div
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        onClick={handleClickGetProductNewPage}
                                        style={{}}
                                    >
                                        Показать еще
                                    </div>
        ...
        return (
            ...
            >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Input
                                    ...
                                    maxlenght={30}
                                    onChange={handleGetInput}
                                    onEventEnterPressed={handleClickGetProduct}
                                />
                                <div
                                    style={{
                                        position: "absolute",
                        ...
                        >
                            ...
                            <FlagButton
                                ...
                                text="Популярности"
                                initialState={isActivePopular}
                                onChangeActive={handleIsActivePopular}
                                onChangeDirectionSorting={
                                    handleIsDirectionPopular
                                }
                            />
                ...
                {isShowMenuSettings ? (
                    ...
                    >
                        <div
                            className={styles.mobile_menu_flex}
                            style={{ gap: "40px" }}
                        >
                            <div
                                style={{
...
export default catalogCurrencyPage;

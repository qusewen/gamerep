...
import {
    BackgroundStatusKeys,
    OrderPanelProp,
    StatusKeys,
} from "../../interfaces/orderPanel";
...
import {
    BackgroundStatusKeys as SubscriptionBackgroundStatusKeys,
    StatusKeys as SubscriptionStatusKeys,
} from "../../interfaces/subscriptionData";
...
const adminChatPage: FunctionComponent = () => {
    ...
    const get_orders = async () => {
        ...
        try {
            const response = await axios.get(
                "/api/v1/admin/chats/" + selectChat?.id + "/",
                {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
            ...
            if (
                selectChat?.order &&
                selectChat?.order?.status === response.data.order.status
            )
                return;
            if (
                selectChat?.ticket &&
                selectChat?.ticket?.status === response.data.ticket.status
            )
                return;
    ...
    const connectWebSocket = () => {
        ...
        if (
            connection.current &&
            connection.current.readyState !== WebSocket.CLOSED
        ) {
            connection.current.close();
        }

        const newWs = new WebSocket(
            "wss://server.gamevizor.ru/ws/chat/" +
                selectChat.id +
                "/?token=" +
                accessToken
        );
    ...
    const sendFileMessage = async (e: any) => {
        ...
        try {
            const response = await axios.put(
                "/api/v1/profile/chats/" + selectChat.id + "/load_file/",
                data,
                {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                                    ...
                                    <div className={styles.chats_list}>
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src={
                                                        "/icons/bases/arrows/arrow_right.svg"
                                                    }
                                                />
                                                <div>Назад</div>
                                            </Link>
                                                    ...
                                                    >
                                                        ...
                                                        selectChat?.id ? (
                                                            ...
                                                            >
                                                                        ...
                                                                        >
                                                                            <img
                                                                                src={
                                                                                    chat
                                                                                        ...
                                                                                        ? chat
                                                                                              ...
                                                                                              ?.profile
                                                                                              .image
                                                                                        : "/images/bases/base_image_for_profile.png"
                                                                                }
                                                                                width={
                                                                                    40
                                                                                }
                                                                                ...
                                                                                style={{
                                                                                    borderRadius:
                                                                                        "50%",
                                                                                    border: chat?.counter_no_read_message
                                                                                        ? "4px solid #FF007A"
                                                                                        : "none",
                                                                                }}
                                                                            />
                                                                            {chat.counter_no_read_message >
                                                                                0 && (
                                                                                <div
                                                                                    style={{
                                                                                        position:
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    {chat
                                                                                        ...
                                                                                        "PRODUCT"
                                                                                            ...
                                                                                            ? "Подписка "
                                                                                            : "") +
                                                                                            chat?.order?.product?.title?.slice(
                                                                                                0,
                                                                                                14
                                                                                            ) ??
                                                                                            "") +
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    {chat
                                                                                        ?.order
                                                                                        ?.wallet &&
                                                                                        `на ${chat?.order?.wallet?.number} ${chat?.order?.wallet?.select_country?.tag}`}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            style={{
                                                                                backgroundColor:
                                                                                    BackgroundStatusKeys[
                                                                                        chat
                                                                                            .order
                                                                                            .status as keyof typeof BackgroundStatusKeys
                                                                                    ],
                                                                            }}
                                                                        >
                                                                            {
                                                                                StatusKeys[
                                                                                    chat
                                                                                        .order
                                                                                        .status as keyof typeof StatusKeys
                                                                                ]
                                                                            }
                                                                        </div>
                                                                    ) : null}
                                                                ...
                                                                >
                                                                    {chat?.order?.chat.last_message.slice(
                                                                        0,
                                                                        50
                                                                    )}
                                                                    {chat?.order
                                                                        ...
                                                                        50 &&
                                                                        "..."}
                                                                    {chat?.ticket?.chat?.last_message?.slice(
                                                                        0,
                                                                        50
                                                                    )}
                                                                    {(chat
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            style={{
                                                                ...
                                                                borderRadius:
                                                                    "50%",
                                                                border: "3px solid rgb(255, 0, 122)",
                                                            }}
                                                        />
                                                        <MyTextAreaInput
                                                            value={

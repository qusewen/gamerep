    ...
    const fetchUsers = async (is_search = false) => {
        ...
        try {
            ...
            if (filterClient) {
                url += "&is_active=1";
                url += `&ordering=${
                    orderingClient ? (orderingClient ? "-pk" : "pk") : "pk"
                }`;
            }
                            ...
                            <div className={styles.general}>
                                ...
                                >
                                    ...
                                    <FlagButton
                                        ...
                                        text="Все клиенты"
                                        initialState={filterAllClient}
                                        onChangeActive={HandleSelectAllClient}
                                        onChangeDirectionSorting={
                                            setOrderingAllClient
                                        }
                                    />
                                    <FlagButton
                                        className={styles.flag_button}
                                        text="Клиенты"
                                        initialState={filterClient}
                                        onChangeActive={HandleSelectClient}
                                        onChangeDirectionSorting={
                                            setOrderingClient
                                        }
                                    />
                                    <FlagButton
                                        className={styles.flag_button}
                                        text="Черный список"
                                        initialState={filterBlockClient}
                                        onChangeActive={HandleSelectBlockClient}
                                        onChangeDirectionSorting={
                                            setOrderingBlockClient
                                        }
                                    />
                                </div>

...
const AdminWalletPage: FunctionComponent = () => {
    ...
    const [isVisibleCreateWalletRule, setIsVisibleCreateWalletRule] =
        useState(false);

    const [listWalletRules, setListWalletRules] = useState<
        adminWalletInterface[]
    >([]);
                    ...
                    <div className={styles.background}>
                        ...
                        <div className={styles.main_panel}>
                            ...
                            <div className={styles.general}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            style={{ width: "280px" }}
                                            onClick={() => {
                                                setIsVisibleCreateWalletRule(
                                                    true
                                                );
                                            }}
                                        >
                                            Добавить правила для валюты
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    {isVisibleCreateWalletRule ? (
                                        <RuleWalletPanel
                                            panel={{}}
                                            country_wallets={contryWallet}
                                            is_edit
                                            funcDelete={() => {
                                                setIsVisibleCreateWalletRule(
                                                    false
                        ...
                        <div className={styles.general}>
                            <div style={{ display: "flex", gap: "25px" }}>
                                ...
                                <div
                                    ...
                                    style={{ width: "280px" }}
                                    onClick={() => {
                                        setIsVisibleCreateWalletRule(true);
                                    }}
                                >
                            ...
                            >
                                {isVisibleCreateWalletRule ? (
                                    <RuleWalletPanel
                                        ...
                                        is_edit
                                        funcDelete={() => {
                                            setIsVisibleCreateWalletRule(false);
                                            DeleteFunc();
                                        }}
                                    />
                                ) : null}

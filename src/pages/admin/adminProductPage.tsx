                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <FlagButton
                                            ...
                                            text="Все товары"
                                            initialState={filterAllProduct}
                                            onChangeActive={
                                                HandleSelectAllProduct
                                            }
                                            onChangeDirectionSorting={
                                                setOrderingAllProduct
                                            }
                                        />
                                        <FlagButton
                                            className={styles.flag_button}
                                            text="Подписки"
                                            initialState={filterSubscription}
                                            onChangeActive={
                                                HandleSelectPublicSubscription
                                            }
                                            onChangeDirectionSorting={
                                                setOrderingSubscription
                                            }
                                        />
                                        <FlagButton
                                            className={styles.flag_button}
                                            text="Игры"
                                            initialState={filterGames}
                                            onChangeActive={
                                                HandleSelectHideGames
                                            }
                                            onChangeDirectionSorting={
                                                setOrderingGames
                                            }
                            ...
                            >
                                ...
                                >
                                    ...
                                    <FlagButton
                                        ...
                                        text="Все товары"
                                        initialState={filterAllProduct}
                                        onChangeActive={HandleSelectAllProduct}
                                        onChangeDirectionSorting={
                                            setOrderingAllProduct
                                        }
                                    />

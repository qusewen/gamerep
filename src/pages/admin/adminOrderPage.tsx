...
const AdminOrderPage: FunctionComponent = () => {
    ...
    const [orderingProcessingOrder, setOrderingProcessingOrder] =
        useState(false);
    ...
    const fetchFeedback = async (is_search = false) => {
        ...
        if (filterProcessingOrder) {
            url +=
                "&status=WAITING" +
                `&ordering=${orderingProcessingOrder ? "pk" : "-pk"}`;
        }
        if (filterCompletedOrder) {
            url +=
                "&status=COMPLETED" +
                `&ordering=${orderingCompletedOrder ? "pk" : "-pk"}`;
        }
    ...
    useEffect(() => {
        ...
        orderingAllOrder,
        orderingProcessingOrder,
        orderingCompletedOrder,
    ]);
                            ...
                            <div className={styles.general}>
                                ...
                                >
                                    ...
                                    <FlagButton
                                        className={styles.flag_button}
                                        text="Принятые"
                                        initialState={filterProcessingOrder}
                                        onChangeActive={
                                            HandleSelectPublicFeedback
                                        }
                                        onChangeDirectionSorting={
                                            setOrderingProcessingOrder
                                        }
                                    />
                                    <FlagButton
                                        className={styles.flag_button}
                                        text="Выполненные"
                                        initialState={filterCompletedOrder}
                                        onChangeActive={
                                            HandleSelectHideFeedback
                                        }
                                        onChangeDirectionSorting={
                                            setOrderingCompletedOrder
                                        }
                                    />
                                </div>

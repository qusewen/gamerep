...
const SubscriptiosPage: FunctionComponent = () => {
    ...
    if (width >= maxWidth) {
        return (
            ...
            >
                <div style={{ background: "#120F25", zoom: 0.9 }}>
                ...
                <BaseCenterContainer style={{ zoom: 0.9 }}>
                    <div className={styles.container}>
                        ...
                        {subscriptions.filter(
                            (item) => item.subscription_type == "PS_PLUS"
                        ).length > 0 ? (
                            <div
                                style={{
                                    display: "flex",
                                                    ...
                                                    type={
                                                        TypeKeys[
                                                            subscription.title.split(
                                                                " "
                                                            )[0] as keyof typeof TypeKeys
                                                        ]
                                                    }
                                                    title={subscription.title}
                                                    duration={
                                                        subscription.subscription_duration_mouth +
                                                        " Мес *"
                                                    }
                        ...
                        {subscriptions.filter(
                            (item) => item.subscription_type == "EA_PLAY"
                        ).length > 0 ? (
                            <div
                                style={{
                                    display: "flex",
                        ...
                        {subscriptions.filter(
                            (item) => item.subscription_type == "XBOX_ULTIMATE"
                        ).length > 0 ? (
                            <div
                                style={{
                                    display: "flex",

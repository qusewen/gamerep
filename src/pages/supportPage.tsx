...
const SupportPage: FunctionComponent = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                if (response.status === 200) SetTicketsList(response.data);
            })
            .catch((error) => {
    ...
    useEffect(() => {
        ...
        axios
            .get("/api/v1/profile/tickets/get_themes/", {
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
            })
                        ...
                        <div className={styles.main_panel}>
                            ...
                            <div className={styles.general}>
                                <div className={styles.title}>
                                    <div>
                                        Обратная связь и контакты поддержки
                                    </div>
                                    <Link
                                        to={"/profile/supports/ticket/create"}

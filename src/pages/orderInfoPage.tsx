...
const OrderInfoPage: FunctionComponent = () => {
    ...
    useEffect(() => {
        if (Order) {
            ...
            setFormattedStatus(
                StatusKeys[Order?.status as keyof typeof StatusKeys]
            );

            setBackgroundColorStatus(
                BackgroundStatusKeys[
                    Order?.status as keyof typeof BackgroundStatusKeys
                ]
            );
        }
    }, [Order]);
    ...
    const SendFeedback = async () => {
        try {
            const response = await axios.post(
                "/api/v1/order/feedback/" + Order?.id + "/",
                {
                    text: feedBackInput,
                    ...
                    <div className={styles.background}>
                        ...
                        <div className={styles.base_path}>
                            ...
                            <span style={{ color: " var(--color-white)" }}>
                                {Order?.product?.title ??
                                    `Пополнение кошелька на ${Order?.wallet?.number} ${Order?.wallet?.select_country?.tag}`}
                            </span>
                        </div>
                                ...
                                {Order?.status === "COMPLETED" ? (
                                    <div>
                                        {Order?.feedback ? (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <img
                                                                ...
                                                                src={
                                                                    "/images/bases/gameVizorLogo.png"
                                                                }
                                                            />
                                                            <div
                                                                style={{
                                            ...
                                            <div
                                                className={
                                                    styles.container_input_feedback
                                                }
                                            >
                                                <textarea
                                                    className={
                                                        styles.input_feedback
                                                    }
                                    ...
                                    <div>
                                        Отзыв возможно оставить только после
                                        выполнения заказа
                                    </div>
                                )}
                            </div>
        ...
        return (
            ...
            >
                <BaseCenterContainer>
                    <Header
                        is_select_id_menu={
                            Order?.product?.product_type === "PRODUCT" ? 2 : 3
                        }
                    />
                    <div

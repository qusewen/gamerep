...
function WalletPage() {
    ...
    const [contryWallet, setCountryWallet] = useState<
    ...
    useEffect(() => {
        ...
        setSelectValue({
            value: contryWallet[0]?.id,
            label: contryWallet[0]?.title,
        });
    }, [contryWallet]);
    ...
    const handleNavigate = () => {
        ...
        navigate(
            `../order/create?type=WALLET&value=${valueForWallet}&country=${selectValue?.value}` +
                (PromoCode ? `&promocode=${PromoCode?.title}` : "")
        );
    };
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            5. После оплаты, вам напишет наш
                                            сотрудник в чате, для уточнения и
                                            пополнения кошелька{" "}
                                        </div>
                                    </div>
                                </div>
                                <div className={styles.wallet_menu}>
                                    ...
                                    <Input
                                        ...
                                        type="number"
                                        label="Введите сумму"
                                        value={valueForWallet}
                                        onChange={(value) => {
                                            setValueForWallet(parseInt(value));
                                        }}
                                    />
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                К оплате :{" "}
                                {get_price_from_promocode(cost, PromoCode).cost}{" "}
                                ₽{" "}
                                {PromoCode ? (
                                    <div
                                        style={{

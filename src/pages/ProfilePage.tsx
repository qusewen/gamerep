                                    ...
                                    >
                                        ...
                                        {isClient ? (
                                            <BaseSwitch
                                                checked={
                                                    user?.profile
                                                        .receive_notifications_on_telegram
                                                }
                                                onValueChange={(value) => {
                                                    if (user) {
                                                        setUser({
                                    ...
                                    >
                                        ...
                                        {isClient ? (
                                            <BaseSwitch
                                                checked={
                                                    user?.profile
                                                        .receive_notifications_on_new_message
                                                }
                                                onValueChange={(value) => {
                                                    if (user) {
                                                        setUser({
                                    ...
                                    >
                                        ...
                                        {isClient ? (
                                            <BaseSwitch
                                                checked={
                                                    user?.profile
                                                        .receive_notifications_on_change_status_order
                                                }
                                                onValueChange={(value) => {
                                                    if (user) {
                                                        setUser({
                        ...
                        <div className={styles.general}>
                            ...
                            >
                                ...
                                <MyReactSelect
                                    ...
                                    value={{
                                        value: user?.profile.console_generation,
                                        label: user?.profile.console_generation,
                                    }}
                                    style={{ width: "314px" }}
                                    instanceId={useId()}
                                />

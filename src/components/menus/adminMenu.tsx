...
const AdminMenu: React.FC<ProfileMenuProps> = ({ selected, style }) => {
    ...
    return (
        <div className={styles.menu} style={style}>
            ...
            <Link to={"../admin/sales"} className={styles.panel} style={selected == 11 ? { background: "var(--color-deeppink)" } : {}}><img src="/icons/profile_panel/octicon_gift-24.svg" className={styles.icon} />Акции</Link>

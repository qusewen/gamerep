...
import {
    NewFileProductInteface,
    PlatformProductInterface,
    ProductInterface,
...
const AdminProductPanel: FunctionComponent<adminTeamPanelProps> = ({
    product,
    funcDelete,
    platforms,
    is_edit = false,
    ...
    const platforms_subscriptions = [
        { value: "PS_PLUS", label: "PS PLUS" },
        { value: "EA_PLAY", label: "EA PLAY" },
        { value: "XBOX_ULTIMATE", label: "XBOX ULTIMATE" },
    ];
    ...
    const HandleDetele = async () => {
        try {
            const response = await axios.delete(
                "/api/v1/admin/products/" + productPanel.id + "/",
                {
                    headers: {
    ...
    const HandleSave = async (changeVisible = false) => {
        ...
        try {
            var response = await axios.put(url, productPanel, {
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
            });
        ...
        if (images) {
            sortedImages.forEach((image, index) => {
                ...
                data.append(
                    `images_or_videos_position[${index}]`,
    ...
    const HandleAddPlatforms = (title: string) => {
        ...
        if (!platform) return;
        if (
            productPanel.platforms?.filter((item) => item.title == title)
                .length === 1
        ) {
            setProductPanel({
                ...productPanel,
                platforms: productPanel.platforms.filter(
                    (item) => item.title !== platform.title
                ),
            });
        } else {
            setProductPanel({
                ...productPanel,
                platforms: [...productPanel.platforms, platform],
            });
        }
    };
                ...
                {isEdit ? (
                    ...
                    >
                        <div style={{ display: "flex", gap: "50px" }}>
                            ...
                            >
                                <label
                                    htmlFor={"general_image" + productPanel?.id}
                                ...
                                <input
                                    id={"general_image" + productPanel?.id}
                            ...
                            >
                                <Input
                                    ...
                                    value={productPanel.title}
                                    label={"Название"}
                                    style={{ width: "642px", height: "42px" }}
                                    onChange={(value) => {
                                        setProductPanel({
                                            ...productPanel,
                                            title: value,
                                ...
                                {productPanel?.product_type == "PRODUCT" ? (
                                    <MyTextAreaInput
                                        ...
                                        value={productPanel.description}
                                        style={{
                                            resize: "none",
                                            height: "77px",
                                        }}
                                ...
                                <div style={{ display: "flex", gap: "25px" }}>
                                    ...
                                    <Input
                                        ...
                                        value={
                                            productPanel.discount?.data_to_end
                                        }
                                ...
                                "SUBSCRIPTION" ? (
                                    ...
                                    >
                                        ...
                                        <ReactSelect
                                            ...
                                            defaultValue={{
                                                value: productPanel.subscription_type,
                                                label: platforms_subscriptions.find(
                                                    (item) =>
                                                        item.value ===
                                                        productPanel.subscription_type
                                                )?.label,
                                            }}
                                            onChange={(value) => {
                                                setProductPanel({
                                ...
                                "SUBSCRIPTION" ? (
                                    <Input
                                        ...
                                        value={
                                            productPanel?.subscription_duration_mouth
                                        }
                                        onChange={(value) => {
                                            setProductPanel({
                                                ...productPanel,
                                                subscription_duration_mouth:
                                                    parseFloat(value),
                                            });
                                        }}
                                    />
                                ...
                                {productPanel?.product_type == "PRODUCT" ||
                                productPanel?.product_type == "CURRENCY" ? (
                                    <div
                                    ...
                                    >
                                        ...
                                        <Checkbox
                                            label="PS4"
                                            checked={productPanel?.platforms.some(
                                                (platforms) =>
                                                    platforms.title === "PS4"
                                            )}
                                            onChange={() =>
                                                HandleAddPlatforms("PS4")
                                            }
                                        />
                                        <Checkbox
                                            label="PS5"
                                ...
                                {productPanel?.product_type == "PRODUCT" ? (
                                    ...
                                    >
                                        ...
                                        <Checkbox
                                            label="Это deluxe/premium издание?"
                                            checked={
                                                productPanel.is_deluxe_or_premium
                                            }
                                            onChange={(value) =>
                                                setProductPanel({
                                                    ...productPanel,
                                                    is_deluxe_or_premium: value,
                                                })
                                            }
                                        />
                                    </div>
                                ...
                                productPanel.is_deluxe_or_premium ? (
                                    ...
                                    >
                                        <div>
                                            Настройки deluxe/premium издания:
                                        </div>
                                    </div>
                                ) : null}
                                ...
                                productPanel.is_deluxe_or_premium ? (
                                    ...
                                    >
                                        <Input
                                            placeholder="Цена"
                                            value={
                                                productPanel.deluxe_or_premium_cost
                                            }
                                            label="Цена deluxe/premium издания"
                                            min={1}
                                            style={{
                                                width: "200px",
                                                height: "42px",
                                        ...
                                        <Input
                                            ...
                                            label="Скидка deluxe/premium издания"
                                            min={1}
                                            style={{
                                                width: "200px",
                                                height: "42px",
                                ...
                                productPanel?.product_type == "CURRENCY" ? (
                                    ...
                                    >
                                        ...
                                        <Checkbox
                                            label="Новинка"
                                            checked={productPanel?.is_novelty}
                                            onChange={(value) =>
                                                setProductPanel({
                                                    ...productPanel,
                                                    is_novelty: value,
                                ...
                                {productPanel?.product_type == "PRODUCT" ? (
                                    ...
                                    >
                                        ...
                                        <Checkbox
                                            ...
                                            checked={productPanel?.is_rus_voice}
                                            onChange={(value) =>
                                                setProductPanel({
                                                    ...productPanel,
                                                    is_rus_voice: value,
                                        ...
                                        <Checkbox
                                            ...
                                            checked={
                                                productPanel?.is_rus_subtitle
                                            }
                                            onChange={(value) =>
                                                setProductPanel({
                                                    ...productPanel,
                                                    is_rus_subtitle: value,
                                                })
                                            }
                                        />
                                    </div>
                                                ...
                                                <img
                                                    src={
                                                        image1
                                                            ...
                                                            : productPanel.images_or_videos?.find(
                                                                  (image) =>
                                                                      image.position ===
                                                                      1
                                                              )?.file ||
                                                ...
                                                <img
                                                    src={
                                                        backgroundImage
                                                            ...
                                                            : productPanel.background_image ||
                                                              "/images/bases/new_background_photo.png"
                                                    }
                                                    width={"80px"}
                                                    height={"80px"}
                                                    style={{
                ...
                {isEdit ? (
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Input
                                placeholder={"Добавьте скидкой для товара"}
                                label={"Скидка"}
                                style={{ width: "194px", height: "42px" }}
                                type="number"
                                value={productPanel?.discount?.discount_cost}
                                onChange={(value) => {
                                    setProductPanel({
                                        ...productPanel,
                                        discount: {
                                            discount_cost: parseFloat(value),
                                            data_to_end:
                                                productPanel?.discount
                                                    ?.data_to_end ?? "",
                                        },
                            ...
                            <Input
                                ...
                                value={productPanel.discount?.data_to_end}
                                label="Дата окончания скидки"
                                onChange={(value) => {
                                    setProductPanel({
                                        ...productPanel,
                        ...
                        productPanel?.product_type == "CURRENCY" ? (
                            ...
                            >
                                ...
                                <Checkbox
                                    label="PS4"
                                    checked={productPanel?.platforms.some(
                                        (platforms) => platforms.title === "PS4"
                                    )}
                                    onChange={() => HandleAddPlatforms("PS4")}
                                />
                                <Checkbox
                                    label="PS5"
                                    checked={productPanel?.platforms.some(
                                        (platforms) => platforms.title === "PS5"
                                    )}
                                    onChange={() => HandleAddPlatforms("PS5")}
                                />
                            </div>
                        ) : null}
                        ...
                        {productPanel?.product_type == "PRODUCT" ? (
                            ...
                            >
                                ...
                                <Checkbox
                                    label="Это deluxe/premium издание?"
                                    checked={productPanel.is_deluxe_or_premium}
                                    onChange={(value) =>
                                        setProductPanel({
                                            ...productPanel,
                                            is_deluxe_or_premium: value,
                        ...
                        productPanel.is_deluxe_or_premium ? (
                            ...
                            >
                                <Input
                                    placeholder="Цена"
                                    value={productPanel.deluxe_or_premium_cost}
                                    label="Цена deluxe/premium издания"
                                    min={1}
                                    style={{ width: "200px", height: "42px" }}
                                    onChange={(value) =>
                        ...
                        {productPanel?.product_type == "PRODUCT" ? (
                            ...
                            >
                                ...
                                <Checkbox
                                    label="Русские субтитры"
                                    checked={productPanel?.is_rus_subtitle}
                                    onChange={(value) =>
                                        setProductPanel({
                                            ...productPanel,
                                            is_rus_subtitle: value,
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                {productPanel.title}{" "}
                                {productPanel.product_type === "SUBSCRIPTION" &&
                                    `${productPanel.subscription_duration_mouth} мес`}
                            </div>

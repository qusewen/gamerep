...
const adminTeamPanel: FunctionComponent<adminTeamPanelProps> = ({
    staff,
    employee,
    roles,
    funcDelete,
    ...
    const HandleSave = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                "/api/v1/admin/staffs/" + staffPanel.id + "/",
                staffPanel,
                {
                    headers: {
    ...
    const handleCheckboxChange = (permission: string) => {
        if (staffPanel.permissions.includes(permission)) {
            setStaffPanel({
                ...staffPanel,
                permissions: staffPanel.permissions.filter(
            ...
            setStaffPanel({
                ...staffPanel,
                permissions: [...staffPanel.permissions, permission],
            });
        }
    };
                ...
                {isEdit ? (
                    <div style={{ display: "flex", gap: "25px" }}>
                        ...
                        >
                            <div style={{ display: "flex", gap: "25px" }}>
                                <Input
                                    value={staffPanel.user.username}
                                    onChange={HandleChangeUsername}
                                    style={{ width: "279px", height: "32px" }}
                                    label="Имя"
                                />
                                <Input
                                    value={"@" + staffPanel.user.nickname}
                                    style={{ width: "279px", height: "32px" }}
                                    label="Никнейм"
                                />
                            </div>
                            ...
                            <div style={{ display: "flex", gap: "25px" }}>
                                <MyPhoneInput
                                    value={staffPanel.user.phone_number}
                                    style={{ width: "279px" }}
                                    label={"Телефон"}
                                />
                                <Input
                            ...
                            <div style={{ display: "flex", gap: "25px" }}>
                                ...
                                >
                                    <Checkbox
                                        label={"Добавление новых сотрудников"}
                                        disabled={
                                        ...
                                        checked={staffPanel.permissions.includes(
                                            "create_employee"
                                        )}
                                        onChange={() =>
                                    ...
                                    />
                                    <Checkbox
                                        label={"Право на просмотр статистики"}
                                        disabled={
                                            staff.id === employee?.id ||
                                            !(
                                                (0 ?? employee?.role) <
                                        ...
                                        onChange={() =>
                                            handleCheckboxChange("view_stats")
                                        }
                                    />
                                </div>
                            </div>
                            <div style={{ display: "flex", gap: "25px" }}>
                                ...
                                >
                                    <Checkbox
                                        label={"Добавление новых товаров"}
                                        disabled={
                                            staff.id === employee?.id ||
                                            !(
                                                (0 ?? employee?.role) <
                                        ...
                                        onChange={() =>
                                            handleCheckboxChange("add_products")
                                        }
                                    />
                                    <Checkbox
                                        label={"Редактирование стоимости"}
                                        disabled={
                                            staff.id === employee?.id ||
                                            !(
                                                (0 ?? employee?.role) <
                                        ...
                                        onChange={() =>
                                            handleCheckboxChange("edit_prices")
                                        }
                                    />
                                    <Checkbox
                                    ...
                                    <Checkbox
                                        label={
                                            "Редактирование информации товара"
                                        }
                                        disabled={
                                            staff.id === employee?.id ||
                                            !(
                            ...
                            <div style={{ display: "flex", gap: "25px" }}>
                                ...
                                >
                                    <Checkbox
                                        label={"Создание чатов с командой"}
                                        disabled={
                                            staff.id === employee?.id ||
                                            !(
                                                (0 ?? employee?.role) <
                                        ...
                                        onChange={() =>
                                            handleCheckboxChange("create_chats")
                                        }
                                    />
                                </div>
                            </div>
                            <div style={{ display: "flex", gap: "25px" }}>
                                ...
                                >
                                    <Checkbox
                                        ...
                                        onChange={() =>
                                            handleCheckboxChange("manage_forum")
                                        }
                                    />
                                </div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <Checkbox
                                        label={
                                            "Создание правил для пополнение кошелька"
                                        }
                                        disabled={
                                            staff.id === employee?.id ||
                                            !(
            ...
            <div className={styles.container}>
                {isEdit ? (
                    ...
                    >
                        ...
                        {staffPanel?.id === employee?.id ? (
                            ...
                            <MyReactSelect
                                isSearchable={false}
                                options={roles.filter(
                                    (role) => role.value > (0 ?? employee?.role)
                                )}
                                defaultValue={roles.find(
                                    (role) => role.value === staffPanel?.role
                                )}
                                onChange={(value: any) =>
                                    setStaffPanel({
                                        ...staffPanel,
                        ...
                        >
                            <Checkbox
                                ...
                                disabled={
                                    staff.id === employee?.id ||
                                    !((0 ?? employee?.role) < staff.role)
                                }
                                checked={staffPanel.permissions.includes(
                                    "create_employee"
                                )}
                                onChange={() =>
                                    handleCheckboxChange("create_employee")
                                }
                            />
                            <Checkbox
                                label={"Выдача прав сотрудникам"}
                        ...
                        >
                            ...
                            <Checkbox
                                ...
                                onChange={() =>
                                    handleCheckboxChange("delete_products")
                                }
                            />
                            <Checkbox
                                label={"Скрытие товаров"}
                                ...
                                onChange={() =>
                                    handleCheckboxChange("hide_products")
                                }
                            />
                            <Checkbox
                                label={"Редактирование информации товара"}
                                disabled={
                                    staff.id === employee?.id ||
                                    !((0 ?? employee?.role) < staff.role)
                                }
                                ...
                                onChange={() =>
                                    handleCheckboxChange("edit_product_info")
                                }
                            />
                        </div>
                        ...
                        >
                            <Checkbox
                                label={"Блокировка и удаление пользователей"}
                                disabled={
                                    staff.id === employee?.id ||
                                    !((0 ?? employee?.role) < staff.role)
                                }
                        ...
                        >
                            <Checkbox
                                ...
                                onChange={() =>
                                    handleCheckboxChange("create_promocodes")
                                }
                            />
                            <Checkbox
                                label={"Создание скидок и акций"}
                                ...
                                onChange={() =>
                                    handleCheckboxChange("create_discounts")
                                }
                            />
                        </div>
                        ...
                        >
                            <Checkbox
                                ...
                                onChange={() =>
                                    handleCheckboxChange("change_wallet_rules")
                                }
                            />
                        </div>
                    ...
                    >
                        ...
                        <div style={{ color: "white" }}>
                            {staffPanel.about_me || "Краткое описание о себе"}
                        </div>
                        <div style={{ color: "white" }}>
                            {staffPanel.user.phone_number}
                        </div>
                        <div style={{ color: "white" }}>
                            {staffPanel.user.nickname}
                        </div>
                        <div>Роль: </div>
                        <Input
                            label={"Роль сотрудника"}

...
import styles from "./FeedbackInfoFrame.module.css";
...
const FeedbackInfoFrame: FunctionComponent<childprops> = ({
    is_mobile = false,
}) => {
    ...
    useEffect(() => {
        axios.get("/api/v1/feedbacks/?page=" + 1, {}).then((response) => {
            setData(response.data);
        });
    }, []);

    useEffect(() => {
        axios.get("/api/v1/feedbacks/get_random/", {}).then((response) => {
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            ...
                            >
                                {formatNumber(Data?.average_rating ?? 0)}
                            </div>
                            <div
                                style={{
                                    display: "flex",
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            {Feedbacks.map(
                                (feedback: feedbackInterface, index) => {
                                    return (
                                        <Feedback
                                            key={index}

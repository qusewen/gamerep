...
const adminClientPanel: FunctionComponent<adminTeamPanelProps> = ({
    user,
    employee,
    funcDelete,
}) => {
    ...
    const handleBlockUser = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                "/api/v1/admin/users/" + userPanel.pk + "/",
                userPanel,
                {
                    headers: {
                ...
                {isEdit ? (
                    ...
                    >
                        <div style={{ display: "flex", gap: "30px" }}>
                            ...
                            >
                                <Input
                                    style={{ width: "578px", height: "42px" }}
                                    label="Имя"
                                    value={userPanel.username}
                                    onChange={HandleChangeUsername}
                                />
                                <div style={{ display: "flex", gap: "20px" }}>
                                    <MyPhoneInput
                                        value={userPanel.phone_number}
                                        style={{ width: "279px" }}
                                        label={"Телефон"}
                                ...
                                <div style={{ display: "flex", gap: "20px" }}>
                                    ...
                                    <select
                                        name="console"
                                        className={styles.select_console}
                                        value={
                                            userPanel?.profile
                                                ?.console_generation
                                        }
                                ...
                                <MyTextAreaInput
                                    label="Примечание о клиенте (не отображается у клиента)"
                                    style={{ resize: "none", height: "82px" }}
                                    placeholder={
                                        "Впечатления о сделке с клиентом ..."
                                    }
                                />
                            </div>
                        </div>
                    ...
                    >
                        <div style={{ display: "flex", gap: "50px" }}>
                            ...
                            >
                                ...
                                <div>
                                    {userPanel?.profile?.console_generation}
                                </div>
                                <div
                                    style={{
                                        color: "white",
                ...
                {isEdit ? (
                    ...
                    >
                        ...
                        >
                            ...
                            <select
                                name="console"
                                className={styles.select_console}
                                value={userPanel?.profile?.console_generation}
                                onChange={() => {}}
                            >
                                <option value={"PS4"}>PS4</option>
                                <option value={"PS5"}>PS5</option>
                    ...
                    >
                        ...
                        <Link
                            ...
                            to={"../admin/chat/?search=" + userPanel?.email}
                        >
                            ЧАТ С КЛИЕНТОМ
                        </Link>
                        ...
                        >
                            ...
                            <div
                                ...
                                onClick={() => setIsVisibleDeleteWindow(true)}
                            >
                                Удалить <TrashIcon fill="#FF6062" />
                            </div>
                        </div>

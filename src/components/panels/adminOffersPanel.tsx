...
const AdminOffersPanel: FunctionComponent<adminTeamPanelProps> = ({
    promocode,
    funcDelete,
    listProduct,
    listCountryWallet,
    ...
    const [promocodePanel, setPromocodePanel] =
        useState<PromoCodeData>(promocode);
    ...
    const HandleDetele = async () => {
        try {
            const response = await axios.delete(
                "/api/v1/admin/promocodes/" + promocodePanel.id + "/",
                {
                    headers: {
    ...
    const HandleSave = async (changeVisible = false) => {
        ...
        let url =
            ...
            (promocodePanel.id ? promocodePanel.id + "/" : "");
        if (changeVisible) {
            promocodePanel.is_active = !promocodePanel.is_active;
        }

        try {
            const response = await axios.put(url, promocodePanel, {
                headers: {
                    Authorization: `Bearer ${accessToken}`,
                },
            });
                ...
                {isEdit ? (
                    ...
                    >
                        ...
                        >
                            ...
                            <div style={{ display: "flex", gap: "25px" }}>
                                <Input
                                    label="Дата"
                                    type="date"
                                    value={promocodePanel.expiry_date}
                                    onChange={(value) => {
                                        setPromocodePanel({
                                            ...promocodePanel,
                                            expiry_date: value,
                                ...
                                <MyReactSelect
                                    ...
                                    value={{
                                        value: promocodePanel?.for_product,
                                        label: options_for_product[
                                            promocodePanel?.for_product
                                        ],
                                    }}
                                    onChange={(value) => {
                                        setPromocodePanel({
                                            ...promocodePanel,
                                            for_product: value.value as
                                                | "ALL"
                                                | "PRODUCT"
                                                | "SUBSCRIPTION"
                                                | "WALLET",
                                ...
                                <Input
                                    label="Кол. Использований"
                                    type="number"
                                    value={promocodePanel.number_of_uses}
                                    onChange={(value) => {
                                        setPromocodePanel({
                                            ...promocodePanel,
                                            number_of_uses: parseInt(value),
                                        });
                                    }}
                                />
                            </div>

                            {promocodePanel.for_product === "PRODUCT" ? (
                                <MyReactSelect
                                    isSearchable
                                    label="Выберите продукт"
                                    value={{
                                        value: promocodePanel.select_product,
                                        label: listProduct.find(
                                            (item) =>
                                                item.value ==
                                                promocodePanel.select_product
                                        )?.label,
                                    }}
                                    onChange={(value) => {
                                        setPromocodePanel({
                                    ...
                                    options={listProduct.filter(
                                        (item) => item.type == "PRODUCT"
                                    )}
                                />
                            ) : null}

                            {promocodePanel.for_product === "SUBSCRIPTION" ? (
                                <MyReactSelect
                                    isSearchable
                            ...
                            {promocodePanel.for_product === "WALLET" ? (
                                <MyReactSelect
                                    isSearchable
                                    label="Выберите страну пополнения"
                                    value={{
                                        value: promocodePanel.select_product,
                                        label: listCountryWallet.find(
                                            (item) =>
                                                item.value ==
                                                promocodePanel.select_wallet
                                        )?.label,
                                    }}
                                    onChange={(value) => {
                                        setPromocodePanel({
                            ...
                            <ReactSelect
                                ...
                                value={{
                                    value: promocodePanel?.for_user,
                                    label: usersOptions.find(
                                        (item) =>
                                            item.value ==
                                            promocodePanel?.for_user
                                    )?.label,
                                }}
                                onChange={(value: any) => {
                                    setPromocodePanel({
                                        ...promocodePanel,
                                        for_user: value.value,
                                    });
                                }}
                            />
                            <MyTextAreaInput
                                value={promocodePanel.description}
                                onChange={(value) => {
                                    setPromocodePanel({
                                        ...promocodePanel,
                                        description: value,
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {promocodePanel.is_active === false ? (
                                        <span
                                            style={{
                                                display: "flex",
                                                alignItems: "center",
                    ...
                    >
                        <div style={{ display: "flex", gap: "10px" }}>
                            ...
                            <div style={{ width: "80px", textWrap: "nowrap" }}>
                        ...
                        <div style={{ display: "flex", gap: "35px" }}>
                            <div style={{ width: "50px" }}>
                                {promocode?.number_of_uses_now}/
                                {promocode?.number_of_uses}
                            </div>
                            <div style={{ width: "200px", textWrap: "nowrap" }}>
                                {
                                    usersOptions.find(
                                        (item) =>
                                            item.value ===
            ...
            <div className={styles.container}>
                {isEdit ? (
                    ...
                    >
                        ...
                        <ReactSelect
                            ...
                            value={{
                                value: promocodePanel.type,
                                label: ListType.find(
                                    (item) => item.value === promocodePanel.type
                                )?.label,
                            }}
                            defaultValue={{
                                value: promocodePanel.type,
                        ...
                        {promocodePanel.for_product === "PRODUCT" ? (
                            <MyReactSelect
                                ...
                                onChange={(value) => {
                                    setPromocodePanel({
                                        ...promocodePanel,
                                        select_product: value.value as number,
                                    });
                                }}
                                options={listProduct.filter(
                                    (item) => item.type == "PRODUCT"
                        ...
                        {promocodePanel.for_product === "WALLET" ? (
                            <MyReactSelect
                                ...
                                onChange={(value) => {
                                    setPromocodePanel({
                                        ...promocodePanel,
                                        select_wallet: value.value as number,
                                    });
                                }}
                                options={listCountryWallet}
                            />
                        ...
                        <ReactSelect
                            ...
                            value={{
                                ...
                                label: usersOptions.find(
                                    (item) =>
                                        item.value == promocodePanel?.for_user
                                )?.label,
                            }}
                            onChange={(value: any) => {
                                setPromocodePanel({
                    ...
                    >
                        ...
                        <div>
                            Кол. использований: {promocode.number_of_uses_now}/
                            {[promocode.number_of_uses]}
                        </div>
                        <div>
                            Для продукта:{" "}

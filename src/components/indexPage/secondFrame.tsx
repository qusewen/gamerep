        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ display: "flex", gap: "20px" }}>
              ...
              <Link to={"../replenishment/"} style={{ textDecoration: "none" }}><InfoPanel title="Пополнения" description="Кошельков" image={"/images/products/mobile/info_panel_wallet.png"} is_mobile /></Link>

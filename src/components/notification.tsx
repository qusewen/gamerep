        ...
        <div style={{ display: "flex" }}>
            ...
            >
                <div className={styles.notificationGroup}>
                    <NotificationIcon
                        color={isHovered ? "var(--color-deeppink)" : "#7E7E7E"}
                        hoverColor="var(--color-deeppink)"
                    />
                    {notifications.filter((item) => item.is_checked === false)
                        .length > 0 && (
                        <div
                            className={styles.number}
                            style={{ minWidth: "10px", left: "17px" }}
                        >
                            <b>
                                {
                ...
                >
                    ...
                    >
                        <div className={styles.notification_panel}>
                            ...
                            <div
                                style={{ height: "141px", overflowY: "auto" }}
                                ...
                                {notifications.map((notification, index) => (
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            className={styles.info_notification}
                                        >
                                            <div
                                                style={{
                                                    display: "flex",
                                            ...
                                            >
                                                <img
                                                    src={
                                                        ...
                                                        "PROMO_CODE"
                                                            ? "/images/bases/promocode_icon.png"
                                                            : notification.image
                                                            ? notification.image

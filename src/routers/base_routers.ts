...
import ReplenishmentPage from "../pages/ReplenishmentPage/ReplenishmentPage";
...
export const base_routers: router[] = [
    ...
    {
        path: "/profile/supports/ticket/create",
    ...
    { path: "/admin/sales", component: AdminSalesPage, only_admin: true },

    { path: "/offer", component: OfferPage },
    { path: "/confidential", component: ConfidentialPage },

    { path: "/sales", component: SalePage },
    { path: "/replenishment", component: ReplenishmentPage },
